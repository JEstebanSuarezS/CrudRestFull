...
export default function Articles() {
    ...
    const destroyArticles = async (id) => {
        let response = await fetch(
            `https://restful-api-project-7zvg.onrender.com/api/v1/articles/${id}`,
            {
                method: "DELETE"
            }
        );
    ...
    return (
        <>
            <div class="relative overflow-x-auto shadow-md h-screen dark:bg-gray-900">
                <h1 className="text-center text-[2em] whitespace-nowrap dark:text-white">List of Articles!</h1>
                                ...
                                <>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="pl-3">
                                                <div class="text-base font-semibold">{elemento.title}</div>
                                        ...
                                        <td class="px-6 pt-4">
                                            <Link
                                                to={`/putArticles/${elemento.id}`}
                                                className="font-medium text-blue-600 dark:text-blue-500 hover:underline text-[1.2em]"
                                            ><HiPencil /></Link>
                                        </td>
                                        <td class="px-6 pt-4">
                                            <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline text-[1.2em]" onClick={() => destroyArticles(elemento.id)}><HiOutlineTrash /></a>
                                        </td>
                                    </tr >
                                </>
